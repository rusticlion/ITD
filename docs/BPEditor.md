...
- The editor supports common templates: no effect, add next symbol, channel symbol, auto assign, heal self, damage opponent part, and gain crest.
...
- Prototype spellmark effects are preserved and exported, but they do not have a dedicated form template yet.
